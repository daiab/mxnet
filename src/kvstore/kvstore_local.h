...
class KVStoreLocal : public KVStore {
   public:
    ...
    virtual ~KVStoreLocal() { delete comm_; }
   ...
   protected:
    ...
    void GroupKVPairs(const std::vector<int>& keys,
                      const std::vector<V>& values, std::vector<int>* uniq_keys,
        ...
        std::sort(idx.begin(), idx.end(),
                  [](const Idx& a, const Idx& b) { return a.first < b.first; });
