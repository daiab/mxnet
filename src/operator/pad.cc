    ...
    for (k = 0; k < nslices; k++) {
        ...
        for (i = 0; i < oheight; i++) {
            for (j = 0; j < owidth; j++) {
                ...
                DType *dest_p =
                    dst.dptr_ + k * owidth * oheight + i * owidth + j;
                DType *src_p =
                    src.dptr_ + k * iwidth * iheight + ip_y * iwidth + ip_x;
                *dest_p = *src_p;
            }
        }
    }
    ...
    for (k = 0; k < nslices; k++) {
        ...
        for (i = 0; i < oheight; i++) {
            for (j = 0; j < owidth; j++) {
                ...
                DType *src_p =
                    grad_out.dptr_ + k * owidth * oheight + i * owidth + j;
                DType *dest_p =
            ...
            for (i = 0; i < oheight; i++) {
                for (j = 0; j < owidth; j++) {
                    ...
                    DType *src_p = src.dptr_ + k * iwidth * iheight * idepth +
                                   ip_z * iwidth * iheight + ip_y * iwidth +
                                   ip_x;
                    *dest_p = *src_p;
                }
            }
        ...
        for (z = 0; z < odepth; z++) {
            for (i = 0; i < oheight; i++) {
                for (j = 0; j < owidth; j++) {
                    ...
                    DType *src_p = grad_out.dptr_ +
                                   k * owidth * oheight * odepth +
                                   z * owidth * oheight + i * owidth + j;
                    DType *dest_p =
                        grad_in.dptr_ + k * iwidth * iheight * idepth +
        ...
        for (d = 0; d < in_grad.size(1); ++d) {
            for (h = 0; h < in_grad.size(2); ++h) {
                for (w = 0; w < in_grad.size(3); ++w) {
                    in_grad[c][d][h][w] +=
                        out_grad[c][d + pad_f][h + pad_t][w + pad_l];
                }
            }
        }
    }
        ...
        for (k = 0; k < odepth; k++) {
            for (i = 0; i < oheight; i++) {
                for (j = 0; j < owidth; j++) {
                    ...
                    DType *src_p = grad_out.dptr_ +
                                   l * owidth * oheight * odepth +
                                   k * owidth * oheight + i * owidth + j;
                    DType *dest_p =
                        grad_in.dptr_ + l * iwidth * iheight * idepth +
                        ip_z * iwidth * iheight + ip_y * iwidth + ip_x;
                    *dest_p += *src_p;
                }
            }
...
MXNET_REGISTER_OP_PROPERTY(Pad, PadProp)
    .describe(
        R"code(Pads an input array with a constant or edge values of the array.
