...
class InstanceNormOp : public Operator {
   public:
    ...
    virtual void Forward(const OpContext &ctx,
        ...
        const real_t scale =
            static_cast<real_t>(1) / static_cast<real_t>(rest_dim);
        // Get Inputs
        Tensor<xpu, 2> data =
        ...
        Tensor<xpu, 1> beta =
            in_data[instance_norm::kBeta].get<xpu, 1, real_t>(s);
        // Get Outputs
        Tensor<xpu, 2> out =
            out_data[instance_norm::kOut].get_with_shape<xpu, 2, real_t>(s2, s);
        Tensor<xpu, 1> var =
            out_data[instance_norm::kVar].FlatTo1D<xpu, real_t>(s);
        Tensor<xpu, 1> mean =
    ...
    virtual void Backward(const OpContext &ctx,
        ...
        Tensor<xpu, 1> gbeta =
            in_grad[instance_norm::kBeta].get<xpu, 1, real_t>(s);
        // Get Outputs
        Tensor<xpu, 2> gout =
