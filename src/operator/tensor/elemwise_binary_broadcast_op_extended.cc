...
Example::
   ...
   broadcast_power(x, y) = [[ 2.,  2.,  2.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow_op::power>)
...
NNVM_REGISTER_OP(_backward_broadcast_power)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryBroadcastBackwardUseIn<cpu, mshadow_op::power_grad,
                                     mshadow_op::power_rgrad>);

MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_maximum)
    .describe(
        R"code(Returns element-wise maximum of the input arrays with broadcasting.
...
Example::
   ...
   broadcast_maximum(x, y) = [[ 1.,  1.,  1.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow_op::maximum>)
...
MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_minimum)
    .describe(
        R"code(Returns element-wise minimum of the input arrays with broadcasting.
...
Example::
   ...
   broadcast_maximum(x, y) = [[ 0.,  0.,  0.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow_op::minimum>)
    .set_attr<nnvm::FGradient>("FGradient", ElemwiseGradUseIn{
...
MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_hypot)
    .describe(
        R"code( Returns the hypotenuse of a right angled triangle, given its "legs"
with broadcasting.
...
Example::
   ...
   broadcast_hypot(x, z) = [[ 3.,  3.,  3.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow_op::hypot>)
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseIn{"_backward_broadcast_hypot"});
...
NNVM_REGISTER_OP(_backward_broadcast_hypot)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryBroadcastBackwardUseIn<cpu, mshadow_op::hypot_grad_left,
