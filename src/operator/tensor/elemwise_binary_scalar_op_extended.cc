...
MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_maximum_scalar)
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarCompute<cpu, mshadow_op::maximum>)
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseIn{"_backward_maximum_scalar"})
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_maximum_scalar)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarBackward<cpu, mshadow_op::ge>);

MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_minimum_scalar)
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarCompute<cpu, mshadow_op::minimum>)
    .set_attr<nnvm::FGradient>("FGradient",
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_minimum_scalar)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarBackward<cpu, mshadow_op::le>);

MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_power_scalar)
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarCompute<cpu, mshadow_op::power>)
    .set_attr<nnvm::FGradient>("FGradient",
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_power_scalar)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarBackward<cpu, mshadow_op::power_grad>);

MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_rpower_scalar)
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarCompute<cpu, mshadow_op::rpower>)
    .set_attr<nnvm::FGradient>("FGradient",
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_rpower_scalar)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarBackward<cpu, mshadow_op::rpower_grad>);

MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_hypot_scalar)
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarCompute<cpu, mshadow_op::hypot>)
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseIn{"_backward_hypot_scalar"})
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_hypot_scalar)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarBackward<cpu, mshadow_op::hypot_grad_left>);
...
Example::
  ...
  smooth_l1([1, 2, 3, 4], sigma=1) = [0.5, 1.5, 2.5, 3.5]
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryScalarCompute<cpu, mshadow_op::smooth_l1_loss>)
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseIn{"_backward_smooth_l1"});
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_smooth_l1)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryScalarBackward<cpu, mshadow_op::smooth_l1_gradient>);
