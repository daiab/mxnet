...
MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_add)
    ...
    .describe(
        R"code(Returns element-wise sum of the input arrays with broadcasting.
...
Example::
   ...
   broadcast_plus(x, y) = [[ 1.,  1.,  1.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow::op::plus>)
...
NNVM_REGISTER_OP(_backward_broadcast_add)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastBackwardUseNone<
...
MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_sub)
    ...
    .describe(
        R"code(Returns element-wise difference of the input arrays with broadcasting.
...
Example::
   ...
   broadcast_minus(x, y) = [[ 1.,  1.,  1.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow::op::minus>)
    .set_attr<nnvm::FGradient>("FGradient",
...
NNVM_REGISTER_OP(_backward_broadcast_sub)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastBackwardUseNone<
                            cpu, mshadow_op::identity, mshadow_op::negation>);

MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_mul)
    .describe(
        R"code(Returns element-wise product of the input arrays with broadcasting.
...
Example::
   ...
   broadcast_mul(x, y) = [[ 0.,  0.,  0.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow::op::mul>)
    .set_attr<nnvm::FGradient>("FGradient",
...
MXNET_OPERATOR_REGISTER_BINARY_BROADCAST(broadcast_div)
    .describe(
        R"code(Returns element-wise division of the input arrays with broadcasting.
...
Example::
   ...
   broadcast_div(x, y) = [[ 3.,  3.,  3.],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastCompute<cpu, mshadow::op::div>)
    .set_attr<nnvm::FGradient>("FGradient",
...
NNVM_REGISTER_OP(_backward_broadcast_div)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        BinaryBroadcastBackwardUseIn<cpu, mshadow_op::div_grad,
