...
NNVM_REGISTER_OP(topk)
    .describe(
        R"code(Returns the top *k* elements in an input array along the given axis.
    ...
    .set_attr<nnvm::FGradient>(
        ...
        [](const nnvm::NodePtr& n, const std::vector<nnvm::NodeEntry>& ograds) {
            ...
            if (param.ret_typ == topk_enum::kReturnValue ||
                ...
                return MakeNonlossGradNode("_backward_topk", n, {ograds[0]},
                                           inputs, n->attrs.dict);
            } else {
...
NNVM_REGISTER_OP(sort)
    .describe(
        R"code(Returns a sorted copy of an input array along the given axis.
    ...
    .set_attr<nnvm::FGradient>(
        ...
        [](const nnvm::NodePtr& n, const std::vector<nnvm::NodeEntry>& ograds) {
            ...
            return MakeNonlossGradNode(
                "_backward_topk", n, {ograds[0]}, inputs,
...
NNVM_REGISTER_OP(argsort)
    .describe(
        R"code(Returns the indices that would sort an input array along the given axis.
