...
MXNET_OPERATOR_REGISTER_BINARY(elemwise_add)
    ...
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseNone{"_backward_add"});

// specialized gradient add function to do add to optimization
// this must differ from elemwise_add to prevent add to optimization in forward
// pass.
...
NNVM_REGISTER_OP(_backward_add)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryBackwardUseNone<cpu, mshadow_op::identity, mshadow_op::identity>);
...
MXNET_OPERATOR_REGISTER_BINARY(_sub)
    ...
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseNone{"_backward_sub"});
...
NNVM_REGISTER_OP(_backward_sub)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryBackwardUseNone<cpu, mshadow_op::identity, mshadow_op::negation>);
...
NNVM_REGISTER_OP(_backward_mul)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryBackwardUseIn<cpu, mshadow_op::right, mshadow_op::left>);
...
NNVM_REGISTER_OP(_backward_div)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        BinaryBackwardUseIn<cpu, mshadow_op::div_grad, mshadow_op::div_rgrad>);
