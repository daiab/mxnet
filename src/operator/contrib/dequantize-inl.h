...
struct dequantize {
    ...
    MSHADOW_XINLINE static void Map(int i, DstDType* out, const SrcDType* in,
        ...
        out[i] =
            static_cast<DstDType>((in[i] + half_range) * scale + *imin_range);
    }
};

template <typename xpu>
void DequantizeCompute(const nnvm::NodeAttrs& attrs, const OpContext& ctx,
