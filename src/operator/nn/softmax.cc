...
Example::
  ...
  softmax(x,axis=1) = [[ 0.33333334,  0.33333334,  0.33333334],
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        SoftmaxCompute<cpu, mxnet_op::softmax_fwd>)
...
MXNET_OPERATOR_REGISTER_BINARY(_backward_softmax)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        SoftmaxGradCompute<cpu, mshadow::op::mul, mxnet_op::softmax_bwd>);
...
Examples::
  ...
  array([[-0.34115392, -0.69314718, -1.24115396],
    ...
    .set_attr_parser(ParamParser<SoftmaxParam>)
    .set_attr<FCompute>("FCompute<cpu>",
                        SoftmaxCompute<cpu, mxnet_op::log_softmax_fwd>)
    .set_attr<nnvm::FGradient>("FGradient",
                               ElemwiseGradUseOut{"_backward_log_softmax"})
    .add_arguments(SoftmaxParam::__FIELDS__());
