...
struct PrvMemDescr {
    ...
    enum PrvDescrType { PRV_DESCR_MKL2017, PRV_DESCR_MKLDNN };
...
struct MKLMemHolder {
    ...
    bool b_eager_mode;
    void disable_prv_2_cpu(bool flag) { b_disable_prv_2_cpu = flag; }
    void set_eager_mode(bool eager_mode) { b_eager_mode = eager_mode; }
    ...
    bool head_at_prv() { return (head_ == HEAD_AT_PRV) ? true : false; }
    void* prv_data(bool allocate_when_uninit = true) {
        ...
        return reinterpret_cast<void*>(
            prv_descriptor_->prv_ptr(allocate_when_uninit));
    }
