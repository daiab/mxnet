...
template <typename Dtype>
inline dnnError_t dnnReleaseBuffer(void* ptr);
template <>
inline dnnError_t dnnReleaseBuffer<float>(void* ptr) {
    return dnnReleaseBuffer_F32(ptr);
}
template <>
inline dnnError_t dnnReleaseBuffer<double>(void* ptr) {
...
template <>
inline dnnError_t dnnLayoutDelete<float>(dnnLayout_t layout) {
    return dnnLayoutDelete_F32(layout);
}
template <>
inline dnnError_t dnnLayoutDelete<double>(dnnLayout_t layout) {
...
template <>
inline dnnError_t dnnWaitFor<float>(dnnPrimitive_t primitive) {
    return dnnWaitFor_F32(primitive);
}
template <>
inline dnnError_t dnnWaitFor<double>(dnnPrimitive_t primitive) {
...
template <>
inline dnnError_t dnnDelete<float>(dnnPrimitive_t primitive) {
    return dnnDelete_F32(primitive);
}
template <>
inline dnnError_t dnnDelete<double>(dnnPrimitive_t primitive) {
...
inline dnnError_t dnnGroupsConvolutionCreateForward<float>(
    ...
    return dnnGroupsConvolutionCreateForward_F32(
        pConvolution, attributes, algorithm, groups, dimension, srcSize,
        dstSize, filterSize, convolutionStrides, inputOffset, border_type);
}
template <>
...
inline dnnError_t dnnReLUCreateForward<float>(
    ...
    return dnnReLUCreateForward_F32(pRelu, attributes, dataLayout,
                                    negativeSlope);
}
template <>
inline dnnError_t dnnReLUCreateForward<double>(
    dnnPrimitive_t* pRelu, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float negativeSlope) {
    return dnnReLUCreateForward_F64(pRelu, attributes, dataLayout,
                                    negativeSlope);
}
...
inline dnnError_t dnnLRNCreateForward(dnnPrimitive_t* pLrn,
                                      dnnPrimitiveAttributes_t attributes,
                                      const dnnLayout_t dataLayout,
                                      size_t kernel_size, float alpha,
                                      float beta, float k);
template <>
...
inline dnnError_t dnnConcatCreate(dnnPrimitive_t* pConcat,
                                  dnnPrimitiveAttributes_t attributes,
                                  const size_t N, dnnLayout_t src[]);
template <>
...
inline dnnError_t dnnSplitCreate(dnnPrimitive_t* pSplit,
                                 dnnPrimitiveAttributes_t attributes,
                                 const size_t N, dnnLayout_t src, size_t dst[]);
template <>
...
template <typename Dtype>
inline dnnError_t dnnBatchNormalizationCreateForward_v2(
    dnnPrimitive_t* pBatchNormalization, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float eps, int flags);

template <>
inline dnnError_t dnnBatchNormalizationCreateForward_v2<float>(
    dnnPrimitive_t* pBatchNormalization, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float eps, int flags) {
...
template <>
inline dnnError_t dnnBatchNormalizationCreateForward_v2<double>(
    dnnPrimitive_t* pBatchNormalization, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float eps, int flags) {
...
template <typename Dtype>
inline dnnError_t dnnBatchNormalizationCreateBackward_v2(
    dnnPrimitive_t* pBatchNormalization, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float eps, int flags);

template <>
inline dnnError_t dnnBatchNormalizationCreateBackward_v2<float>(
    dnnPrimitive_t* pBatchNormalization, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float eps, int flags) {
...
template <>
inline dnnError_t dnnBatchNormalizationCreateBackward_v2<double>(
    dnnPrimitive_t* pBatchNormalization, dnnPrimitiveAttributes_t attributes,
    const dnnLayout_t dataLayout, float eps, int flags) {
