...
void SoftmaxCrossEntropyForward(const nnvm::NodeAttrs& attrs,
    ...
    MSHADOW_REAL_TYPE_SWITCH(outputs[0].type_flag_, DType, {
        ...
        tdst =
            F<mshadow_op::negation>(F<mshadow_op::log>(F<mshadow_op::maximum>(
                mat_choose_row_element(temp1, mlabel), scalar<DType>(1e-8f))));
...
void SoftmaxCrossEntropyBackward(const nnvm::NodeAttrs& attrs,
    ...
    MSHADOW_REAL_TYPE_SWITCH(outputs[0].type_flag_, DType, {
        ...
        mshadow::Tensor<xpu, 2, DType> mdata_grad =
            outputs[0].get<xpu, 2, DType>(s);
        ...
        ASSIGN_DISPATCH(mdata_grad, req[0],
