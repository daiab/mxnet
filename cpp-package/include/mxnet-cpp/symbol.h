...
class Symbol {
    ...
    * \param arad_arrays infered arrays to store the gradient output of the
    * input
    * arguments.
    ...
    * \param args_req_type map of some given type of gradient saving. Can only
    * be
    ...
    *  The input arrays in the given maps should have the same name with the
    *input
    *symbol.
    *  Only need some of the necessary arrays, and the other arrays can be
    *infered
    *automatically.
    *
    ...
    *
    * \param context the context of binding.
    * \param arg_arrays the NDArray that stores the input arguments to the
    *symbol.
    * \param grad_arrays NDArray that is used to store the gradient output of
    *the
    *input arguments.
