...
/*!
* \brief Default function for monitor that computes statistics of the input
* tensor,
...
class Monitor {
    ...
    * \param stat_func A function that computes statistics of tensors. Defaults
    * to mean
    ...
    */
    ...
    /*!
    * \brief End collecting for current batch and return results. Call after
    * computation
    * of current batch.
    */
    std::vector<Stat> toc();
   ...
   protected:
    ...
    static void executor_callback(const char *name, NDArrayHandle ndarray,
                                  void *monitor_ptr);
};
